create table random_points(id bigint generated by default as identity primary key, geom geometry(POINT, 4326));

with pts as (
    select (st_dump(ST_GeneratePoints(geom, 10000))).geom
    from (
